...
(custom-set-variables
 ...
 '(package-selected-packages
   '(org-noter yaml-mode xterm-color which-key use-package treemacs-projectile speed-type solarized-theme protobuf-mode pdf-tools magit lsp-pyright helm-xref form-feed dockerfile-mode dired-du dap-mode counsel bazel-mode)))
